...
function ucwc_fx_save($path, $fx) {
    $keys = ["PARTICLES","PARTICLES_COUNT","HUTAO","HUTAO_SIZE","HUTAO_POS","HUTAO_TYPE","HUTAO_BLUR","REDUCE_MOTION","BG_MODE","BG_LOCAL_SLOT","BG_GALLERY","BG_CUSTOM_API","BG_BLUR","FONT_BODY","FONT_TITLE","FONT_TITLE_UPPER","FONT_SIZE","FONT_TITLE_SIZE","FONT_CUSTOM_BODY","FONT_CUSTOM_TITLE","FONT_LOCAL_BODY","FONT_LOCAL_TITLE","COLOR_PRESET","COLOR_TEXT","COLOR_TITLE","COLOR_LABEL"];
    $lines = [];
    foreach ($keys as $k) {
