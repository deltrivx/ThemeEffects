...
function ucwc_fx_normalize_font(&$fx) {
    $bodies = ["system", "rajdhani", "noto_sc", "yahei"];
    $titles = ["orbitron", "match_body", "system", "noto_sc", "yahei"];
    $presets = ["cyber", "ice", "gold", "mint", "custom"];
    $sizes = ["13", "14", "15", "16"];
...
function ucwc_fx_save($path, $fx) {
    $keys = ["PARTICLES","PARTICLES_COUNT","HUTAO","HUTAO_SIZE","HUTAO_POS","HUTAO_TYPE","HUTAO_BLUR","REDUCE_MOTION","BG_MODE","BG_LOCAL_SLOT","BG_GALLERY","BG_CUSTOM_API","BG_BLUR","FONT_BODY","FONT_TITLE","FONT_TITLE_UPPER","FONT_SIZE","COLOR_PRESET","COLOR_TEXT","COLOR_TITLE","COLOR_LABEL"];
    $lines = [];
    foreach ($keys as $k) {
