...
function ucwc_classify_progress($line) {
    ...
    if (preg_match('/ThemeEffects|ThemeEffects_Loader|ucwc-theme-fx|ucwc-update/i', $s)) return ["pct" => 45, "stage" => "部署主题特效"];
...
function classify($line) {
  ...
  if (preg_match('/ThemeEffects|ThemeEffects_Loader|ucwc-theme-fx|ucwc-update/i', $s)) return [48, "部署主题特效"];
