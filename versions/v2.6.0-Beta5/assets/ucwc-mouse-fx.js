...
(function () {
  ...
  var CURSOR_OPTS = ["system", "neon3d", "holo", "cyber", "crystal"];
  var api = {
  ...
  /** Apply theme pointer style via html data attr + classes. */
  function applyCursorStyle() {
    try {
      ...
      // Independent of canvas FX — restyle pointer alone is allowed.
