...
(function (global) {
  ...
  /** Find a host inside the Unraid Dashboard content flow (not body fixed). */
  ...
  function placeInDashboard(card) {
    ...
    // Prefer a dedicated host row at the top of the dash content
    var wrap = document.getElementById("ucwc-music-dash-host");
    if (!wrap) {
      wrap = document.createElement("div");
      wrap.id = "ucwc-music-dash-host";
      // Insert before first dashboard table/tile when possible
      var firstTile =
        host.querySelector("table.dashboard, table.share_status.dashboard, .grid-stack-item, .tile") ||
        host.firstChild;
